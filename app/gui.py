...
Describe your idea in plain language and watch it take shape in immersive three dimensions.  
Perfect for designers, developers, and creators of all kinds!
""")
                ...
                with st.spinner("Working on your creation... This may take a few minutes"):
                    try:
                        ...
                        if "error" in result:
                            ...
                            # Add this once at the top (or before your prompt box rendering)
                            st.markdown("""
    <style>
        .prompt-box {
...
# Then use this line to display the enhanced prompt
